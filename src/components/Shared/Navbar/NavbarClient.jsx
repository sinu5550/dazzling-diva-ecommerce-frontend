...
import { NewIcon, OfferIcon, DropdownIcon } from "@/components/svg";
...
export default function NavbarClient({ data, contactData, config }) {
  ...
  return (
    <>
      ...
      <div
        className={`primary-nav sticky top-0 z-50 transition-all duration-300 bg-white border-t border-gray-100/80 h-[60px] lg:h-[60px] flex items-center font-outfit  ${
          isSticky
            ...
            <div className="hidden lg:grid grid-cols-3 items-center w-full gap-3">
              ...
              <div className="flex items-center gap-5 justify-start">
                ...
                <div className="relative flex-shrink-0 group">
                  ...
                  {/* Dropdown on hover */}
                  <div className="absolute left-0 mt-1.5 w-56 bg-white border border-gray-150 shadow-xl rounded-xl py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                    {mainCategories?.map((mainCat) => (
                      ...
                      >
                        <Link
                          ...
                          className="block px-4 py-2.5 text-[16px] font-normal text-gray-700 hover:bg-gray-50 hover:text-[#5A0C3D] transition-colors"
                        >
                          {mainCat.name}
                        </Link>
                      </div>
                ...
                <Link
                  href="/new-arrival"
                  className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 text-gray-800 text-[16px] font-normal rounded-full border border-[#44444433] transition-all duration-200 flex-shrink-0 whitespace-nowrap"
                >
                  <NewIcon className="w-4 h-4 text-[#5A0C3D]" />
                  <span>New In</span>
                </Link>
                ...
                <Link
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 text-gray-800 text-[16px] font-normal rounded-full border border-[#44444433] transition-all duration-200 flex-shrink-0 whitespace-nowrap"
                >
                  <OfferIcon className="w-4 h-4 text-[#5A0C3D]" />
                  <span>Offers</span>
                </Link>
              </div>
