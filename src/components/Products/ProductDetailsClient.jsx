...
export default function ProductDetailsClient({
  ...
  const validateVariantSelection = () => {
    ...
    if (!variantStatus.exists) {
      toast.error(
        "This combination is not available. Please select another combination.",
      );
      return false;
    }
    ...
    if (!variantStatus.inStock) {
      toast.error(
        "This variant is out of stock. Please select another option.",
      );
      return false;
    }
  ...
  const handleBuyNow = async (e) => {
    ...
    try {
      const checkoutItem = {
        ...
        discountType:
          product.campaignInfo?.discountType ||
      ...
      <Container>
        ...
        <div className="flex">
          <nav className="text-xs md:text-sm text-gray-600 mb-2 flex items-center gap-1.5 md:gap-2 flex-nowrap overflow-hidden">
            ...
            <Link
              href={`/products/category/${product.subCategory?.category?.name}`}
              className="hover:text-primary shrink-0 whitespace-nowrap"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">
          ...
          <div className="space-y-4">
            ...
            <div className="py-4 border-t border-b border-gray-200 text-gray-700">
              <div className="flex items-center gap-4 flex-wrap">
                ...
                {(product.discountValue > 0 ||
                  (product.campaignInfo &&
                    product.campaignInfo.discountValue > 0)) &&
                  originalPrice > discountedPrice && (
                    <>
                      ...
                      <span className="bg-rose-600 text-white text-xs font-bold px-2 py-0.5 rounded">
                        -
                        {product.campaignInfo?.discountValue ||
                ...
                <div className="flex items-center gap-2">
                  {product.taxType === "inclusive" ? (
                    ...
                    <div className="inline-flex items-center gap-1 px-2 py-1 bg-purple-50 border border-purple-200 rounded">
                      <svg
                        className="w-3 h-3 text-secound"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 pt-4">
              ...
              {(!isVariantProduct ||
                (variantStatus.exists && variantStatus.inStock)) && (
              ...
              <div className="flex-1 w-full md:w-auto">
                <div className="grid grid-cols-2 gap-2.5 sm:gap-3">
                  ...
                  <button
                    ...
                    className={`bg-transparent hover:bg-primary border border-primary text-primary hover:text-white py-3 px-3 sm:px-6 font-semibold flex items-center justify-center gap-1.5 transition-all duration-300 uppercase w-full diva-rounded text-xs sm:text-sm tracking-wide
                  ...
                  <button
                    ...
                    className={`bg-primary hover:bg-primary-hover text-white py-3 px-3 sm:px-6 font-semibold transition-all duration-300 uppercase w-full diva-rounded text-xs sm:text-sm tracking-wide flex items-center justify-center gap-1.5
                  ...
                  <a
                    ...
                    className="bg-[#25D366] hover:bg-[#1ebd5a] text-white py-3 px-3 sm:px-6 font-semibold flex items-center justify-center gap-1.5 transition-all duration-300 uppercase w-full diva-rounded text-xs sm:text-sm tracking-wide shadow-sm hover:shadow-md cursor-pointer"
                  >
                    <FaWhatsapp size={17} />
                  ...
                  <a
                    ...
                    className="bg-gray-900 hover:bg-black text-white py-3 px-3 sm:px-6 font-semibold flex items-center justify-center gap-1.5 transition-all duration-300 uppercase w-full diva-rounded text-xs sm:text-sm tracking-wide shadow-sm hover:shadow-md cursor-pointer"
                  >
                    <FaPhoneAlt size={14} />
            ...
            <div className="border-t border-gray-200 pt-4 space-y-2 mt-4">
              <p className="text-sm text-gray-600">
                ...
                <Link
                  href={`/category/${product.subCategory?.category?.mainCategory?.id}`}
                  className="text-secound hover:underline"
                >
                ...
                {",  "}
                <Link
                  href={`/products/${product.subCategory?.id}`}
                  className="text-secound hover:underline"
                >
