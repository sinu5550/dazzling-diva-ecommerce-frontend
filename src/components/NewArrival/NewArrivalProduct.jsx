...
export default function NewProductClient({ initialProducts, isLoading: initialLoading = false }) {
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="bg-white diva-rounded border border-gray-200 p-6 sticky top-24">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <button
                                    ...
                                    className="text-sm text-secound hover:text-secound-hover cursor-pointer flex items-center gap-1"
                                >
                                    <X size={14} />
                                    Clear all
                                </button>
                                ...
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    {(filters.minPrice || filters.maxPrice) && (
                                        <button
                                            ...
                                            className="text-xs text-secound hover:text-secound-hover"
                                        >
                                            Clear
                                        </button>
                                    )}
                                    ...
                                    {priceRanges.map((range) => (
                                        ...
                                        >
                                            <input
                                                ...
                                                className="mr-3 h-4 w-4 text-primary focus:ring-primary border-stone-300"
                                            />
                                ...
                                <div className="mt-4 pt-4 border-t border-gray-200">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="w-full p-2 border border-stone-300 text-sm focus:border-primary focus:ring-primary"
                                            min="0"
                                            step="100"
                                        />
                            ...
                            <button
                                onClick={clearFilters}
                                className="w-full mt-4 bg-primary hover:bg-primary-hover text-white py-2.5 px-4 text-sm font-medium transition-colors cursor-pointer"
                            >
                                Reset All Filters
                            </button>
                        </div>
                ...
                <div className="lg:w-[95%]">
                    ...
                    {filteredProducts.length > 0 ? (
                        <>
                            <NewProductGrid products={filteredProducts} />
                        </>
                    ) : (
